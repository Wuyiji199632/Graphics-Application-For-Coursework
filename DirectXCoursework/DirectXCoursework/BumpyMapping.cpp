...
void BumpyMapping::updateModel(Vector3D position, Vector3D rotation, Vector3D scale, const std::vector<MaterialPtr>& list_materials)
{
	constant cc;
...
void BumpyMapping::updateThirdPersonCamera()
{
...
void BumpyMapping::updateSkyBox()
{
	constant cc;
...
void BumpyMapping::drawMesh(const MeshPtr& mesh, const std::vector<MaterialPtr>& list_materials)
{
	for (unsigned int m = 0; m < list_materials.size(); m++)
	{
...
void BumpyMapping::updateViewportProjection()
{
...
void BumpyMapping::onCreate()
{
	...
	m_brick_mat = GraphicsEngine::get()->createMaterial(L"BumpyVS.hlsl", L"BumpyPS.hlsl");
...
void BumpyMapping::onDestroy()
{
	Window::onDestroy();
	m_swap_chain->setFullScreen(false, 1, 1);
}

void BumpyMapping::onFocus()
{
	InputSystem::get()->addListener(this);
}

void BumpyMapping::onKillFocus()
{
	InputSystem::get()->removeListener(this);
}

void BumpyMapping::onSize()
{
	RECT rc = this->getClientWindowRect();
...
void BumpyMapping::onKeyDown(int key)
{

}

void BumpyMapping::onKeyUp(int key)
{
...
void BumpyMapping::onMouseMove(const Point& mouse_pos)
{
...
void BumpyMapping::onLeftMouseDown(const Point& mouse_pos)
{
	if (!m_play_state)
	{
		m_play_state = true;
...
void BumpyMapping::onLeftMouseUp(const Point& mouse_pos)
{
}

void BumpyMapping::onRightMouseDown(const Point& mouse_pos)
{
}

void BumpyMapping::onRightMouseUp(const Point& mouse_pos)
{
}